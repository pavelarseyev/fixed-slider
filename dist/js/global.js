...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__modules_fixedSlider__ = __webpack_require__(334);
...
Object(__WEBPACK_IMPORTED_MODULE_1__libs_binder__["a" /* binder */])({
    bounds: {
        "html": [],
        "body": [],
        ".fixed-slider": __WEBPACK_IMPORTED_MODULE_2__modules_fixedSlider__["a" /* fixedSlider */]
    },
    runTests: false
});
...
function fixedSlider() {
    ...
    var scrollContainer = $(".slides-wrapper");
    var pusher = $(".pusher");
